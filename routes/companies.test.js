...
describe('GET /companies', function () {
    ...
    test('Uses all filters', async function () {
        const resp = await request(app).get(
            '/companies?name=c&minEmployees=2&maxEmployees=3'
        );
        expect(resp.body).toEqual({
            companies: [
                {
    ...
    test('Filters only name', async function () {
    ...
    test('Filters only minEmployees', async function () {
    ...
    test('Filters only maxEmployees', async function () {
    ...
    test('Throws error if min Employees is greater than maxEmployees', async function () {
        const resp = await request(app).get(
